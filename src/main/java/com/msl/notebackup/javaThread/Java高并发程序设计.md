## 代码Demo: [JavaBaseThreadLearn](https://github.com/SuanCaiYv/Java-Base-Thread)
## 2. Java线程
### 2.1. 线程基本操作
#### 2.1.1. 创建一个线程并运行
...
* JDK的Executor接口仅提供一个execute(Runnable)方法。
  ![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4f125366d45e49b5bc52d2e95d31c208~tplv-k3u1fbpfcp-watermark.image)
